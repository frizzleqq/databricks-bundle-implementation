...
The 'dbx_example' project was generated by using the default-python template.

Uses Databricks Free Edition -> https://www.databricks.com/learn/free-edition
* In EU, this seems to use Clusters with Databricks Runtime 15.1
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] dbx_example_job` to your workspace.
...
4. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/dbx_example.job.yml). The schedule
